...
namespace Octopus.Tentacle.Client.Decorators
{
    ...
    /// </summary>
    internal class HalibutExceptionTentacleServiceDecoratorFactory : ITentacleServiceDecoratorFactory
    {
        ...
        {
            return new ScriptServiceV3AlphaHalibutExceptionTentacleServiceDecorator(service);
        }
    }
    ...
    class HalibutExceptionScriptServiceV2Decorator : IClientScriptServiceV2
    {
        ...
        public ScriptStatusResponseV2 StartScript(StartScriptCommandV2 command, HalibutProxyRequestOptions halibutProxyRequestOptions)
        {
            ...
            catch (Exception e) when (HalibutExceptionTentacleServiceDecoratorFactory.IsHalibutOperationCancellationException(e))
            {
